	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363316942471895@newsletter',
            newsletterName: 'NEKOTINA-BOT 💫', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363316942471895@newsletter", "120363316942471895@newsletter", "120363316942471895@newsletter", "120363316942471895@newsletter"]
let canalNombre = ["𝗔𝗡𝗢𝗧𝗛𝗘𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ⟡ NEKOTINA-BOT 💫", "Nk - UPDATE 🐈", "Tips sobre NekoBot 🤩", "𝗡𝗘𝗪 𝗣𝗥𝗢𝗝𝗘𝗖𝗧 ⟡ NekoTina-Bot v1.2✨"]
