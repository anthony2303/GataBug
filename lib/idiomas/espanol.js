...
const smsLista3 = () => { return `🎁 RENTAR 🎁`}
const smsLista4 = () => { return `🚀 VELOCIDAD 🚀`}
const smsLista5 = () => { return `💡 INFORMACIÓN DEL MENÚ 💡`}
const smsLista6 = () => { return `🌀 MENÚ COMPLETO 🌀`}
const smsLista7 = () => { return `🐈 RENTAR NEKOTINABOT 🐈`}
const smsLista8 = () => { return `🍄 MENU DE LISTADOS DE FREE FIRE 🍄`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 𝗦𝘂𝗽𝗲𝗿 𝙉𝙀𝙆𝙊𝙏𝙄𝙉𝘼 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
//_antispam.js
const smsNoSpam = () => { return `🤨 NO HAGAS SPAM, NO PODRÁ USAR A NEKOTINA POR ${60000 / 1000 - 59} MINUTO`}
